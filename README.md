...
## Usage
- Example codes are [testanimateln](animateln/testanimateln.cpp),[testanimatesln](animatesln/testanimatesln.cpp) and [testspinner](spinner/testspinner.cpp). You can compile them with running ```make``` or ```./compile``` and run them with make run or ./test*FUNCTION*. 
...
Please look at the [LICENSE](LICENSE.md) file for more information.
